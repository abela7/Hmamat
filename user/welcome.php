        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="step-content <?php echo $step === 1 ? 'active' : ''; ?>" id="step1">
                    <h2 class="card-title mb-4 text-center">ስለ ድረ ገጹ</h2>
                    
                    <div class="mb-4">
                        <h3>እዚህ ድረገጽ ላይ የሚያደርጉት ማንኛውም አይነት እንቅስቃሴ በምንም አይነት መልኩ የእርስዎን ማንነት ለሌላ ሰው ሊያሳውቅ ሊያሳውቅ አይችልም። ይህም ማለት እዚህ ላይ የሚሞሉት መንፈሳዊ ተግባራት ክትትሎችን ከእርስዎ በቀር ማንም ሊከታተልዎ ወይንም ሊያውቅ አይችልም። ለመመዝገብ የክርስትና ስም ወይንም ማንኛውንም አይነት ስም መጠቀም ይችላሉ።  
የዚህ ድረ ገጽ ገጹ ዋነኛ አላማ በዐቢይ ጾም የመጨረሻ ሳምንት ሕማማት ላይ የሚያደርጉትን መንፈሳዊ እንቅስቃሴዎች በመከታታል ያሉበትን ሁኔታ ለመገምገም እንዲሁም ሌሎች ምዕመናን ያሉበትን ሁኔታ እያዩ እርስዎም እንዲበረቱ፣ ሌላ ያልበረታ ሰውንም እንዲያበረቱ ታስቦ የተዘጋጀ ነው። ሌሎች ምዕመናን በክርስትና ስምዎ ያስገቡትን መረጃ እንዳያዩት ከፈለጉ ሴቲንግ ላይ ማስተካከል ይችላሉ።
